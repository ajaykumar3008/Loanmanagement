...
<% List<LoanEMIMaster> appList = (List<LoanEMIMaster>) request.getAttribute("emimaster"); %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="content"> <div></div><br><br>
        <h1>Total EMIs</h1>
        <table>
            <tr>
                <th>application Id</th>
                <th>Total EMI Intrest</th>
                <th>NO Of EMIs </th>
            ...
            <% if(appList!=null){for (LoanEMIMaster loan : appList) { %>
                <tr>
                    <td><%= loan.getApplicantid() %></td>
                    <td><%= loan.getEmiIntrest() %></td>
                    <td><%= loan.getNoOfEmis() %></td>
                    <td><%= loan.getSanctionedAmount() %></td>
                    <td><%= loan.getRepayAmount() %></td>
                  
                    <td><a class="btn" href="http://localhost:9010/LoanManagement/emischedule?applicant=<%=loan.getApplicantid() %>">EMI Schedule</a></td>
                </tr>
            <% } }%>
        </table><br><br>
    </div>
