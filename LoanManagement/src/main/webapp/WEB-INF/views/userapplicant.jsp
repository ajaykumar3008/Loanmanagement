...
<body>
    <div class="menu">
        <ul>
            <li><a href="http://localhost:9010/LoanManagement/userapplications"> My Loan Applications</a></li>
    ...
    <div class="content">
       <h1>Loan Application</h1>
        <form action="http://localhost:9010/LoanManagement/emicalculation" method="get">
            ...
            <div align="center">
            <button class="btn btn-primary">Proceed</button></div>
        </form>
    </div>
